...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['TarnSpill',			'tarn',			'i dont DO anything but make concepts..\n(Artist)',							'',		'B42F71'],
			['Fishik',				'discord',			'vs matt mod is crazy!\n(Musician)',						'https://youtube.com/@FushikGodzilla',			'5E99DF'],
			['DumbPNG',				'discord',			'dumb png when crazy.',						'',			'FFFFFF'],
			['NotBepisBO',				'bepis',			'bepsi man.\n(Artist)',						'',			'5E99DF'],
			['YourBoyKris80',			'kris',			'im a sheep. and a guy\n(Musician)',							'',		'B42F71'],
			['PedroGames2',				'pedro',			'im literally just a fan who makes chrom scales for the mod.\n(Chrom Maker)',						'',			'5E99DF'],
			['SomeDudeNamedTim',				'discord',			'i can fix it!\n(Compiler)',						'',			'5E99DF'],
			[''],
			['Psych Engine Team'],
